...
func init() {
	...
	CobraServer.Flags().BoolVarP(&flags.Server.Decrypt, "decrypt", "", false, "decrypt encrypted data dir and profile")
	CobraServer.Flags().BoolVarP(&flags.Server.UpdatePass, "update-password", "", false, "update teamserver password(used for profile encryption)")
