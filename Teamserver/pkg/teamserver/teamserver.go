...
func (t *Teamserver) FindSystemPackages() bool {
    ...
    if err != nil {
        ...
        logger.Info("Mingw x64: " + colors.Blue(t.Settings.Compiler64))
    }
    ...
    if err != nil {
        ...
        logger.Info("Mingw x86: " + colors.Blue(t.Settings.Compiler32))
    }
    ...
    if err != nil {
        ...
        logger.Info("Nasm: " + colors.Blue(t.Settings.Nasm))
    }
