...
VOID DxInitialization( VOID )
{
    ...
    if ( ( ! Instance->Modules.Kernel32 ) || ( Instance->Modules.Ntdll ) )
    {
        ...
        Instance->Win32.GetFileAttributesA                  = LdrFunctionAddr( Instance->Modules.Kernel32, 0xcc9c6ccd );
        Instance->Win32.FindFirstFileA                      = LdrFunctionAddr( Instance->Modules.Kernel32, 0xae2636cf );
        Instance->Win32.FindNextFileA                       = LdrFunctionAddr( Instance->Modules.Kernel32, 0xf3b43c46 );
